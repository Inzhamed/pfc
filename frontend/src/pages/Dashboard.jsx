...
const SimpleCheckbox = ({ id, checked, onChange, label }) => {
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      />
      <label htmlFor={id} className={`text-sm ${isDark ? "text-gray-300" : "text-gray-700"}`}>
        {label}
      </label>
    </div>
  )
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <SimpleCheckbox
                        ...
                        label={<span className="px-2 py-1 bg-red-500 text-white text-xs rounded-full">Critique</span>}
                      />
                      <SimpleCheckbox
                        id="modere"
                        checked={filters.gravite.includes("modere")}
                        onChange={() => handleGraviteChange("modere")}
                        label={<span className="px-2 py-1 bg-orange-500 text-white text-xs rounded-full">Modéré</span>}
                      />
                      <SimpleCheckbox
                        id="mineur"
                        checked={filters.gravite.includes("mineur")}
                        onChange={() => handleGraviteChange("mineur")}
                        label={<span className="px-2 py-1 bg-green-500 text-white text-xs rounded-full">Mineur</span>}
                      />
                    </div>
                  </div>
