    ...
    <div className={`min-h-screen ${isDark ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-800"}`}>
      <div className="max-w-6xl mx-auto py-8 px-4">
        ...
        {loading ? (
          ...
          <>
            <div className={`rounded-lg border ${isDark ? "border-gray-700 bg-gray-800" : "border-blue-100 bg-white"} shadow-sm`}>
              <Table>
            ...
            {selectedItem && (
              <Dialog open={!!selectedID} onOpenChange={() => setSelectedID(null)}>
                <DialogContent className={`max-w-[95vw] max-h-[90vh] overflow-y-auto ${isDark ? "bg-gray-800 border-gray-700" : "bg-white"}`}>
                  <DialogHeader>
                    <DialogTitle className={isDark ? "text-blue-300" : "text-blue-900"}>
                      <div className="flex flex-wrap items-center gap-2">
                        <span className={`font-mono ${isDark ? "bg-blue-900/30" : "bg-blue-100"} px-3 py-1 rounded-md text-sm`}>
                          {selectedItem.id}
                        </span>
                  ...
                  <div className="grid grid-cols-1 gap-4 mt-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <Card className={isDark ? "bg-gray-700 border-gray-600" : "bg-white border-blue-100"}>
                        <CardHeader className="pb-3">
                          <h3 className={`flex items-center gap-2 text-sm font-semibold ${isDark ? "text-blue-300" : "text-blue-900"}`}>
                        ...
                        <CardContent className="space-y-3">
                          <div>
                            <p className={`text-xs ${isDark ? "text-gray-400" : "text-gray-600"} mb-1`}>Nom du technicien</p>
                            <p className={`text-sm ${isDark ? "text-white" : "text-gray-900"}`}>{selectedItem.technician.name}</p>
                          </div>
                          <div>
                            <p className={`text-xs ${isDark ? "text-gray-400" : "text-gray-600"} mb-1`}>Matricule</p>
                            <p className={`text-sm font-mono ${isDark ? "text-white" : "text-gray-900"}`}>{selectedItem.technician.matricule}</p>
                          </div>
                          <div>
                            <p className={`text-xs ${isDark ? "text-gray-400" : "text-gray-600"} mb-1`}>Fonction</p>
                            <p className={`text-sm ${isDark ? "text-white" : "text-gray-900"}`}>{selectedItem.technician.function}</p>
                          </div>
                          <div>
                      ...
                      <Card className={isDark ? "bg-gray-700 border-gray-600" : "bg-white border-blue-100"}>
                        ...
                        <CardContent className="space-y-3">
                          <div>
                            <p className={`text-xs ${isDark ? "text-gray-400" : "text-gray-600"} mb-1`}>Ligne ferroviaire</p>
                            <p className={`text-sm ${isDark ? "text-white" : "text-gray-900"}`}>{selectedItem.line}</p>
                          </div>
                          <div>
                            <p className={`text-xs ${isDark ? "text-gray-400" : "text-gray-600"} mb-1`}>Point kilométrique</p>
                            <p className={`text-sm font-mono ${isDark ? "text-white" : "text-gray-900"}`}>{selectedItem.location.pk}</p>
                          </div>
                          <div>
                            <p className={`text-xs ${isDark ? "text-gray-400" : "text-gray-600"} mb-1`}>Image du défaut</p>
                    ...
                    <Card className={isDark ? "bg-gray-700 border-gray-600" : "bg-white border-blue-100"}>
                      ...
                      <CardContent>
                        <div className={`p-3 rounded text-sm ${isDark ? "bg-gray-600/30 text-gray-200" : "bg-gray-50 text-gray-700"}`}>
